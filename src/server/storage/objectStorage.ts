...
export class ObjectStorageService {
  ...
  // Downloads an object and returns the stream and metadata
  async getObjectStream(file: File) {
    try {
      // Get file metadata
      ...
      logger.error('Error getting object stream:', error)
