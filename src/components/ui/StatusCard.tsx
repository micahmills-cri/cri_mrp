    ...
    return (
      ...
      >
        <CardHeader className="pb-3">
          <div className="flex items-start justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span
                className={clsx('px-3 py-1 rounded-full text-xs font-semibold', 'border')}
                style={{
        ...
        <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              {details.map((detail, index) => (
                <div key={index} className="flex justify-between items-center">
                  <span
                    className={clsx('text-[color:var(--status-muted)] font-medium', {
                      'text-xs': size === 'sm',
                      'text-sm': size === 'md',
                      'text-base': size === 'lg',
                    })}
                  ...
                  <span
                    className={clsx('text-[color:var(--status-foreground)] font-semibold', {
                      'text-xs': size === 'sm',
                      'text-sm': size === 'md',
                      'text-base': size === 'lg',
                    })}
          ...
          {lastUpdated && (
            <div
              className={clsx('text-[color:var(--muted)] pt-2 border-t border-[var(--border)]', {
                'text-xs': size === 'sm',
                'text-sm': size === 'md',
                'text-base': size === 'lg',
              })}
        ...
        {statusCounts.map((item, index) => {
          ...
          return (
            <div key={index} className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <span
                  className={clsx('font-semibold text-[color:var(--foreground)]', {
                    'text-sm': size === 'sm',
                    'text-base': size === 'md',
                    'text-lg': size === 'lg',
                  })}
